//esta funcion se utiliza con el fin de reducir el error de las mediciones del los sensores
//como usamos sensores ultrasonicos para medir el nivel de llenado de los bombos el ruido al usar ultrasonido
//pueden generar errores en la medicion, puede cer que una misma onda llege dos veces y por eso se usa esta funcion toma 10
//mediciones de cada sensor y genera una salida promedio con el fin de suavizar los errores y el ruido 
